...
const IcoTable = ({myWeb3, accounts}) => {
          ...
          const projectData = [
            {
              ...
              status: statusChecker(event.returnValues.startDate * 1000,
                  event.returnValues.endDate * 1000, amountRaised, event.returnValues.minimalProvide)
            },
          ]
  ...
  return (
    <ReactTabulator style={{ width: '80%', margin: ' 1rem auto' }} columns={columns} data={launchedICOs} />
  )
}
