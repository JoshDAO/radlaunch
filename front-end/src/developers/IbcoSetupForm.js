...
import { Box, Form, Input, Select, Field, Button, Text, Checkbox, Radio, Textarea } from 'rimble-ui'
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        ...
        >
          ...
          {submitted && !startDateInFuture ? (
            <Text style={{ color: 'red', fontSize: '1rem' }}>Your start date is in the past!</Text>
          ) : null}
          ...
          <Field style={{ marginLeft: '7rem', width: '70%' }}>
            <label for='min-threshold' style={{ paddingBottom: '0.5rem', textAlign: 'left' }}>
              Minimum Investment Threshold - tokens will only be distributed if your project raises
              more than this amount in ETH
            </label>
            <Input
              id='min-threshold'
              type='text'
        ...
        >
          <Text style={{ textAlign: 'left', padding: '1rem 3rem 2rem 3rem', fontSize: '1rem' }}>
            ...
            participate by committing ETH, thus increasing the price of 1 token in a linear fashion.
            ...
            that size then all investors are returned their investment and your tokens are returned
            to you.
          </Text>
          <Field
            style={{
          ...
          >
            <label for='project-description' style={{ paddingBottom: '0.5rem', textAlign: 'left' }}>
